...
(function(window, angular, undefined) {
  ...
  angular.module('satellizer', [])
    ...
    .factory('satellizer.popup', [
      ...
      'satellizer.utils',
      '$injector',
      function($q, $interval, $window, $location, config, utils, $injector) {
        var popup = {};
        popup.url = '';
        ...
        popup.pollPopup = function() {
          ...
          if(!popup.popupWindow){
            ...
            // oauth.authenticate('facebook', false);
            // popup.popupWindow = popup.open(popup.lastParams.url, popup.lastParams.windowName, popup.lastParams.stringifiedOptions);
